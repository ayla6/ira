...
pub const ENTER_STEAM_ID_GOG: &str = "Enter the Steam app ID to use for trophy definitions:";
pub const PLAY_HISTORY: &str = "Play history";
pub const VIEW_PLAY_HISTORY: &str = "View play history";
pub const SESSION_HISTORY_FOR: &str = "Play history for";
pub const TOTAL_PLAYTIME: &str = "Total playtime";
pub const NO_SESSIONS: &str = "No play sessions recorded yet";
pub const DAILY_HISTORY: &str = "Daily play history";
...
pub const NO_GAMES_FOUND: &str = "No games found";
pub const NO_GAMES_FOUND_DESCRIPTION: &str = "Try a different title, platform, or sort title";
