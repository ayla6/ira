...
pub(super) struct RowActions {
    ...
    /// Console games whose metadata Steam can garnish, linked by exact
    /// title — additive to the SS/RA boxes, and the link repoints the
    /// Steam identity only, never the console one.
