...
struct SavedSettingsWidgets {
    ...
    screenscraper_enable_row: adw::SwitchRow,
    screenscraper_id_row: adw::EntryRow,
    screenscraper_password_row: adw::PasswordEntryRow,
...
fn finish_settings_dialog(params: SettingsDialogParams) {
    ...
    let saved_widgets = SavedSettingsWidgets {
        ...
        screenscraper_enable_row: pages.screenscraper_enable_row,
...
fn apply_general_settings(cfg: &mut Config, widgets: &SavedSettingsWidgets) {
    ...
    cfg.screenscraper_enabled = widgets.screenscraper_enable_row.is_active();
