...
/// one, so the pass costs nothing after its first full sweep. Which
/// consoles hash at all is the per-console policy's call — image-heavy
/// consoles match by serial or title instead.
