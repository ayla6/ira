...
use crate::models::{AppMessage, AppSender, GameEntry, MergedAchievement};
use crate::parser::{load_game, unlock_status_path};
...
fn process_reload(
    ...
    if cfg.notifications_enabled {
        for a in newly_earned {
            crate::watcher::notify::notify_unlock(&game_name, &a);
        }
    }
}
